...
# -------------------------------------------------------------------------
# [파일 불러오기] - 캐글 원본(영어 열 이름)을 한글 열 이름으로 자동 변환!
# -------------------------------------------------------------------------
@st.cache_resource
def load_assets():
    ...
    # 💡 캐글 원본 데이터의 영어 열 이름을 코드가 인식할 수 있게 한글로 자동 변경합니다.
...
# 2. 데이터 전처리 (시간 추출)
# -------------------------------------------------------------------------
# 원본 데이터의 날짜 형식(%Y-%m-%d %H:%M:%S 또는 %d-%m-%Y %H:%M)을 유연하게 맞추기 위해 format을 빼고 처리합니다.
